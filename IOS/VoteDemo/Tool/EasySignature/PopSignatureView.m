...
- (void)setupView
{
    ...
    [OKBtn setTitle:@"Clear" forState:UIControlStateNormal];
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(6, 0, 88, 44)];
    [cancelBtn setTitle:@"Signature" forState:UIControlStateNormal];
    ...
    [btn3 setTitle:@"Submit" forState:UIControlStateNormal];
