...
- (void)CreatekeyWith{
    ...
    BOOL ispubexist= [[NSFileManager defaultManager] fileExistsAtPath:pubPath];
    if (ispubexist) {
        [[NSFileManager defaultManager] removeItemAtPath:pubPath error:nil];
    }
    BOOL ispriexist= [[NSFileManager defaultManager] fileExistsAtPath:priPath];
    if (ispriexist) {
...
-(NSString *) encryptString:(NSString *)str{
    return  [RSAEncryptor encryptString:str publicKey:_PublicKey];
}
...
- (NSString *)decryptString:(NSString *)str{
    return [RSAEncryptor decryptString:str privateKey:_PrivateKey];
}
